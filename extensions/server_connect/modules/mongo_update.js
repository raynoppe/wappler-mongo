...
exports.mongo_update = async function (options, name) {
    ...
    var updata = this.parse(options.vars);
    var newvalues = { $set: updata };
    ...
    try {
        ...
        result = await dCollection.updateOne(q, newvalues);
        return result;
    }
